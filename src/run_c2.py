...
from nets import Net256_Conv4_Fc1_B_RGB_C2, Net256_Conv4_Fc1_B_GRAY_C2
...
class Run():
    ...
    def __init__(self, changes = {'epochs': 3, 'num_aug': 30, 'learning_rate': 0.00015, 'weight_decay': 0.0005, 'batch_size': 100}):
        ...
        self.COLOR_FLAG = cv2.IMREAD_GRAYSCALE #cv2.IMREAD_COLOR

        self.INPUT_DIRECTORY = '01_input_split_Aedes_NoAedes'
        ...
        self.CLASS_LABELS = ['Aedes', 'NonAedes']
        ...
        self.NET = Net256_Conv4_Fc1_B_GRAY_C2() #Net256_Conv4_Fc1_B_RGB_C2()
        self.NET.to(device)
        ...
        #Regarding reviewer 1 comment: L2 regularization we added WEIGHT_DECAY
